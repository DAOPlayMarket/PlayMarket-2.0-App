package com.blockchain.store.playmarket.installer.rootless;
    ...
    public String getErrorString(int status, String blockingPackage) {
        switch (status) {
            case PackageInstaller.STATUS_FAILURE_ABORTED:
                Log.d(TAG, "installer error aborted");
            ...
            case PackageInstaller.STATUS_FAILURE_BLOCKED:
                ...
                if (blockingPackage != null) {
                    String appLabel = MyPackageManager.getAppLabel(getApplicationContext(), blockingPackage);
                    if (appLabel != null)
                        blocker = appLabel;
                }
