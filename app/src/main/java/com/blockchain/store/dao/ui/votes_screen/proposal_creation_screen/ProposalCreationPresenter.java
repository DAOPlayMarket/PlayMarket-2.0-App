...
public class ProposalCreationPresenter implements ProposalCreationContract.Presenter, Callbacks.DaoTokenCallback {
    ...
    public void getDaoTokenBalance() {
        daoTokenRepository.resetLastRequestTime();
